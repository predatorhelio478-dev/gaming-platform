    ...
    return (
        ...
        >
            ...
            >
                ...
                <ChevronDown
                    size={16}
                    className={`shrink-0 text-slate-600 transition-transform ${open
                            ? "rotate-180"
                            : ""
                        }`}
                />
                        ...
                        (option) => {
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex w-full cursor-pointer items-center justify-between rounded-lg px-3 py-2.5 text-left text-sm transition ${active
