                ...
                <UserPageHeader
                    ...
                    description={
                        <>
                            ...
                            {lastUpdatedLabel && (
                                <span className="mt-3 inline-flex items-center gap-1.5 ml-2 rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-[11px] font-semibold text-slate-500">
                                    <Clock size={12} />
